// 星巴克 (com.starbucks.cn) trace launcher
// hook 点：libcfbe0b.so + 0xFED4
// public static native void rh(String str, byte[] bArr);
// 需配合 bypass_bangbang.js 绕过梆梆检测
...
const CONFIG = {
    ...
    options: {
        ...
        anon_trace: true,
        // static method: x0=JNIEnv*, x1=jclass, x2=str, x3=bArr
