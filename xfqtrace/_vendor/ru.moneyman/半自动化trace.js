// MoneyMan (ru.moneyman) trace launcher
// hook 点：libsdk_bc_lib.so + 0x9554C
// 对应 java：com.appsflyer.internal.AFb1nSDK.afRDLognull(...)
...
const CONFIG = {
    ...
    options: {
        ...
        // afRDLog(Map<String,Object>, byte[], Map<String,Object>)
        // 两个 Map 用 .diff 抓 AppsFlyer 在调用过程中往里塞了什么字段
